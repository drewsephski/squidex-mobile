...
SWIFT_PRODUCT="$ROOT_DIR/apps/macos/.build/release/SquidexDesktop"
SWIFT_RESOURCE_BUNDLE="$ROOT_DIR/apps/macos/.build/release/SquidexDesktop_SquidexDesktop.bundle"
...
cp "$SWIFT_PRODUCT" "$APP_DIR/Contents/MacOS/SquidexDesktop"
...
chmod +x "$APP_DIR/Contents/MacOS/SquidexDesktop"
...
<dict>
  ...
  <string>SquidexDesktop</string>
  <key>CFBundleIdentifier</key>
  <string>com.squidex.desktop</string>
  <key>CFBundleInfoDictionaryVersion</key>
  <string>6.0</string>
  <key>CFBundleName</key>
  <string>Squidex</string>
